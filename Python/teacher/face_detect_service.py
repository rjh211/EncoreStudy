...
class FaceDetectService:
    ...
    def face_detect(self):
        ...
        self.classifiers.append(cv2.CascadeClassifier('C:/Users/JH/Desktop/playdata/설치파일/haar training 실행방법 및 테스팅 소스/Haar-Training/cascade2xml/boxdetector.xml'))
...
def main():
    cf = FaceDetectService('scene00001.bmp')
    cf.face_detect()
